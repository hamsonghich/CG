    ...
    <div class="row site-header__bottom-sale">
      <div class="site-header__bottom-sale__child">
        <ul class="d-flex justify-content-start align-items-center flex-wrap  header-menu">
          <li class="header-menu__item1 px--3 h-100 d-flex justify-content-center align-items-center font--semibold  mr--5"
              v-for="(item, index) in this.dataProductLocal"
              :key="index"
          >
              ...
              <div class="container-fluid">
                <div class="row">
                  <div class="col-3 p--0 m--0">
                    <ul>
                      <li v-for="(itemC, indexC) in item['product-sub']" :key="indexC">
                  ...
                  <div class="col-9 p--0 m--0">
                    <div v-if="dataItemsVerticalSidebar">
                      <ul>
                        <li v-for="(item,index) in dataItemsVerticalSidebar?.['product-details']" :key="index">
                          <!--                          {{item}}-->
                          <ul class="d-flex justify-content-start align-items-cente">
...
export default {
  ...
  async created() {
    ...
    this.dataProductLocal = convertDataFirebase(this._dataProduct)
    console.log(  this.dataProductLocal)
