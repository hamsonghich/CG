...
<template>
  <div class="relative flex items-top justify-center min-h-screen bg-gray-100 sm:items-center sm:pt-0 dev">
...
<script>
import Vue from "vue";
import InputWebComponent from "~/components/libs/InputWebComponent.vue";
